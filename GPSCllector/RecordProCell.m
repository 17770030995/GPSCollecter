...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _nameLb = [UILabel labelWithFont:15 Text:@"" Alignment:NSTextAlignmentLeft textColor:UIColorFromRGB(0x000000)];
        ...
        _codeLb = [UILabel labelWithFont:12 Text:@"" Alignment:NSTextAlignmentRight textColor:UIColorFromRGB(0x888888)];
        [_codeLb sizeToFit];
        [topView addSubview:_codeLb];
        ...
        UILabel *result = [UILabel labelWithFont:14 Text:@"维修结果:" Alignment:NSTextAlignmentRight textColor:UIColorFromRGB(0x888888)];
        ...
        _resultLb = [UILabel labelWithFont:14 Text:@"" Alignment:NSTextAlignmentLeft textColor:UIColorFromRGB(0x000000)];
        ...
        UILabel *mate = [UILabel labelWithFont:14 Text:@"材料费:" Alignment:NSTextAlignmentRight textColor:UIColorFromRGB(0x888888)];
        [contentView addSubview:mate];
        [mate mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(contentView.mas_left);
            make.top.equalTo(result.mas_bottom);
            make.width.equalTo(@80);
            make.height.equalTo(@30);
        }];
        _mateCostLb = [UILabel labelWithFont:14 Text:@"" Alignment:NSTextAlignmentLeft textColor:UIColorFromRGB(0x000000)];
        [contentView addSubview:_mateCostLb];
        [_mateCostLb mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(mate.mas_right).offset(10);
            make.centerY.equalTo(mate);
            make.right.equalTo(contentView.mas_right).offset(-10);
            make.height.equalTo(@30);
        }];
        
        UILabel *maint = [UILabel labelWithFont:14 Text:@"维修费:" Alignment:NSTextAlignmentRight textColor:UIColorFromRGB(0x888888)];
        [contentView addSubview:maint];
        [maint mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(contentView.mas_left);
            make.top.equalTo(mate.mas_bottom);
            make.width.equalTo(@80);
            make.height.equalTo(@30);
        }];
        _maintCostLb = [UILabel labelWithFont:14 Text:@"" Alignment:NSTextAlignmentLeft textColor:UIColorFromRGB(0x000000)];
        [contentView addSubview:_maintCostLb];
        [_maintCostLb mas_makeConstraints:^(MASConstraintMaker *make) {
